...
const LOCAL_TASKS_META = [
  {
    ...
    img: "/problemImages/problem4100.png",
    isCompleted: false,
  },
  {
    id: "4101",
    title: "Zadanie 2",
    description: "Równanie iloczynowe - iloczyn rozwiązań",
    img: "/problemImages/problem4101.png",
    isCompleted: false,
  },
  {
    id: "4102",
  ...
  },
  {
    ...
    img: "/problemImages/problem4111.png",
    isCompleted: false,
  },
  {
    id: "4112",
  ...
  },
  {
    ...
    title: "Zadanie 8",
    description: "Równanie iloczynowe",
    img: "/problemImages/problem4113.png",
    isCompleted: false,
  }
];
...
const TopicTasksPage = () => {
  ...
  const firstGroup = tasks.filter(task => parseInt(task.id) >= 4100 && parseInt(task.id) < 4110);
  const secondGroup = tasks.filter(task => parseInt(task.id) >= 4110 && parseInt(task.id) <= 4120)
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats completedCount={completedCount} totalCount={tasks.length} topicTitle={"Równania wielomianowe"} />
