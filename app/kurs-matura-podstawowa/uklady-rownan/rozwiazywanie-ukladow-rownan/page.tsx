...
const tasks = [
  {
    ...
    img: "/problemImages/problem3000.png",
    isCompleted: true,
  },
    {
    id: "3001",
    title: "Podstawowe działania",
    description: "Skorzystaj z własności wartosci bezwzględnej",
    img: "/problemImages/problem3001.png",
    isCompleted: true,
  },
    {
    id: "3002",
    title: "Podstawowe działania",
    description: "Skorzystaj z własności wartosci bezwzględnej",
    img: "/problemImages/problem3002.png",
    isCompleted: true,
  },
    {
    id: "3003",
    title: "Podstawowe działania",
    description: "Skorzystaj z własności wartosci bezwzględnej",
    img: "/problemImages/problem3003.png",
    isCompleted: true,
  },
    {
    id: "3004",
    title: "Podstawowe działania",
    description: "Skorzystaj z własności wartosci bezwzględnej",
    img: "/problemImages/problem3004.png",
    isCompleted: true,
  },
    {
    id: "3005",
    title: "Podstawowe działania",
    description: "Skorzystaj z własności wartosci bezwzględnej",
    img: "/problemImages/problem3005.png",
    isCompleted: true,
  },
    {
    id: "3006",
    title: "Podstawowe działania",
    description: "Skorzystaj z własności wartosci bezwzględnej",
    img: "/problemImages/problem3006.png",
    isCompleted: true,
  },
];
...
const TopicTasksPage = () => {
  ...
  const firstGroup = tasks.filter(task => parseInt(task.id) <= 3003 && parseInt(task.id) >= 3000);
  const secondGroup = tasks.filter(task => parseInt(task.id) <= 3007 && parseInt(task.id) >= 3004);
