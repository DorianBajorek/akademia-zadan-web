...
const LOCAL_TASKS_META = [
  {
    id: "2500",
    title: "Zadanie 1",
    description: "Nierówność liniowe z jedną niewiadomą",
    ...
    title: "Zadanie 2",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2501.png",
    isCompleted: true,
  },
    {
    id: "2502",
    title: "Zadanie 3",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2502.png",
    isCompleted: true,
  },  {
    id: "2503",
    title: "Zadanie 4",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2503.png",
    isCompleted: true,
  },
  {
    id: "2504",
    title: "Zadanie 5",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2504.png",
    isCompleted: true,
  },
    {
    id: "2505",
    title: "Zadanie 6",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2505.png",
    isCompleted: true,
  },
    {
    id: "2506",
    title: "Zadanie 7",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2506.png",
    isCompleted: true,
  },
    {
    id: "2507",
    title: "Zadanie 8",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2507.png",
    isCompleted: true,
  },
    {
    id: "2508",
    title: "Zadanie 9",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2508.png",
    isCompleted: true,
  },
{
    id: "2509",
    title: "Zadanie 10",
    description: "Nierówność liniowe z jedną niewiadomą",
    img: "/problemImages/problem2509.png",
    isCompleted: true,
  }
];
...
const TopicTasksPage = () => {
  ...
  const firstGroup = tasks.filter(task => parseInt(task.id) <= 2503 && parseInt(task.id) >= 2500);
  const secondGroup = tasks.filter(task => parseInt(task.id) <= 2509 && parseInt(task.id) >= 2504);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats completedCount={completedCount} totalCount={tasks.length} topicTitle={"Równania liniowe"} />
