  ...
  const courses = [
    {
      ...
      description:
        'Poznaj podstawy matematyki - działania na liczbach, przedziały, wartość bezwzględną i pierwiastki.',
    ...
    },
    {
      ...
      description:
        'Naucz się przekształcać wyrażenia algebraiczne, wzory skróconego mnożenia i działań na potęgach.',
    ...
    },
    {
      ...
      description:
        'Rozwiązywanie równań kwadratowych, własności funkcji, nierówności oraz wierzchołek.',
    ...
    },
    {
      ...
      title: 'Ciągi',
      description:
        'Poznaj ciągi arytmetyczne i geometryczne, ich monotoniczność oraz sumy wyrazów.',
    ...
    },
    {
      ...
      title: 'Planimetria',
      description:
        'Geometria płaska - własności figur, twierdzenie Pitagorasa, podobieństwo i pola figur.',
    ...
    },
    {
      ...
      description:
        'Proste i figury w układzie współrzędne. Środki prostych - to co maturzsyta musi znać.',
    ...
    },
    {
      ...
      description:
        'Obliczenia kombinatoryczne, prawdopodobieństwo zdarzeń losowych i podstawy statystyki. Zadania z życia codziennego.',
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Wybierz dział, który Cię interesuje i rozpocznij naukę. Śledź swoje postępy i
            systematycznie przygotowuj się do egzaminu.
          </p>
        </div>
        ...
        <div className="my-16 border-t border-gray-300">
          ...
          >
            {exams.map((exam, index) => {
              ...
              return (
                <Link href={`/kurs-matura-podstawowa${exam.slug}`} key={exam.id} className="block">
                  <motion.div
                    variants={item}
                    whileHover={{
                      scale: 1.03,
