...
const LOCAL_TASKS_META = [
  {
    id: "2910",
    title: "Zadanie 1",
    description: "Przesunięcie funkcji kwadratowej",
  ...
  },
  {
    id: "2911",
    title: "Zadanie 2",
    description: "Współcznnik b z postaci iloczynowej",
  ...
  },
  {
    id: "2912",
    title: "Zadanie 3",
    description: "Analiza współczynników funkcji kwadratowej na podstawie jej wykresu",
                            ...
                            const fetchTasks = async () => {
                              ...
                              try {
                                const response = await getProblemProgress(
                                  "funkcje-kwadratowe",
                                  "wlasnosci-wspolczynnikow-funkcji-kwadratowej",
                                  token
                                );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats completedCount={completedCount} totalCount={tasks.length} topicTitle={"Własności współczynników funkcji kwadratowej"} />
