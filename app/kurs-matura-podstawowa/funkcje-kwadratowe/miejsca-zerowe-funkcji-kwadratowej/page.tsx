...
const LOCAL_TASKS_META = [
  {
    id: '1500',
    title: 'Zadanie 1',
    description: 'Miejsce zerowe funkcji kwadratowej',
  ...
  },
  {
    id: '1511',
    title: 'Zadanie 4',
    description: 'Wzór funkcji na podstawie miejsc zerowych',
...
const TopicTasksPage = () => {
  ...
  const secondGroup = tasks.filter(
    (task) => parseInt(task.id) >= 1510 && parseInt(task.id) <= 1520
  );
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats
          ...
          topicTitle={'Miejsca zerowe funkcji kwadratowej'}
        />
