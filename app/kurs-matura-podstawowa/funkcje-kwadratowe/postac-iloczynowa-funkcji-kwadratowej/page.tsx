...
const LOCAL_TASKS_META = [
  ...
  },
  {
    id: "1701",
    title: "Zadanie 2",
    description: "Rozkład do postaci iloczynowej",
    ...
    id: "1702",
    title: "Zadanie 3",
    description: "Współczynniki b i c funkcji kwadratowej",
  ...
  },
  {
    id: "1710",
    title: "Zadanie 1",
    description: "Postać iloczynowa funkcji kwadratowej",
                                  ...
                                  const fetchTasks = async () => {
                                    ...
                                    try {
                                      const response = await getProblemProgress(
                                        "funkcje-kwadratowe",
                                        "postac-iloczynowa-funkcji-kwadratowej",
                                        token
                                      );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats completedCount={completedCount} totalCount={tasks.length} topicTitle={"Postać iloczynowa funkcji kwadratowej"} />
