  ...
  const topics = [
    {
      ...
      shortDesc:
        'Analiza wpływu współczynników a, b, c na wykres funkcji oraz wierzchołek paraboli',
    ...
    },
    {
      ...
      shortDesc:
        'Zapis funkcji kwadratowej w postaci iloczynowej: \( f(x) = a(x - x_1)(x - x_2) \)',
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1">
        ...
        <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 mb-10">
          ...
          <p className="text-gray-700">
            ...
            najwyższy lub najniższy punkt. Poznasz różne formy zapisu funkcji kwadratowej, takie jak
            kanoniczna i iloczynowa, oraz nauczysz się rozwiązywać nierówności kwadratowe.
            Opanowanie tych zagadnień jest niezbędne do analizy i szkicowania wykresów funkcji
            kwadratowych.
          </p>
          <div className="mt-4">
