...
const LOCAL_TASKS_META = [
  {
    id: '3100',
    title: 'Zadanie 1',
    description: 'Oblicz czwarty wyraz ciągu arytmetycznego',
  ...
  },
  {
    id: '3101',
    title: 'Zadanie 2',
    description: 'Wyznacz sumę dziewięciu początkowych wyrazów ciągu arytmetycznego',
  ...
  },
  {
    id: '3102',
    title: 'Zadanie 3',
    description: 'Oblicz pierwszy wyraz i różnicę ciągu arytmetycznego',
  ...
  },
  {
    id: '3103',
    title: 'Zadanie 3',
    description: 'Wyznacz wzór ogólny ciągu arytmetycznego',
    img: '/problemImages/problem3102.png',
    isCompleted: false,
  },
  {
    id: '3110',
    title: 'Zadanie 4',
    description: 'Oblicz szósty wyraz',
  ...
  },
  {
    id: '3111',
    title: 'Zadanie 5',
    description: 'Różnica ciągu arytmetycznego',
    img: '/problemImages/problem3110.png',
    isCompleted: false,
  },
];
...
const TopicTasksPage = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      ...
      try {
        const response = await getProblemProgress('ciagi', 'ciagi-arytmetyczne', token);
  ...
  const secondGroup = tasks.filter(
    (task) => parseInt(task.id) >= 3110 && parseInt(task.id) <= 3120
  );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 pt-8">
        <div className="mb-6">
          <Link
            href="/kurs-matura-podstawowa/ciagi/"
