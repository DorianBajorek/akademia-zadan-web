...
const LOCAL_TASKS_META = [
  {
    id: '3200',
    title: 'Zadanie 1',
    description: 'Wyznacz iloraz i piąty wyraz ciągu geometrycznego',
  ...
  },
  {
    id: '3201',
    title: 'Zadanie 2',
    description: 'Oblicz iloraz ciągu geometrycznego',
  ...
  },
  {
    id: '3210',
    title: 'Zadanie 4',
    description: 'Wyznacz czwarty wyraz ciągu geometrycznego',
  ...
  },
  {
    id: '3214',
    title: 'Zadanie 8',
    description: 'Iloraz ciągu geometrycznego',
...
const TopicTasksPage = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      ...
      try {
        const response = await getProblemProgress('ciagi', 'ciagi-geometryczne', token);
  ...
  const secondGroup = tasks.filter(
    (task) => parseInt(task.id) >= 3210 && parseInt(task.id) <= 3220
  );
