...
const TopicTasksPage = () => {
  ...
  const secondGroup = tasks.filter(task => parseInt(task.id) <= 4009 && parseInt(task.id) >= 4001);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats completedCount={completedCount} totalCount={tasks.length} topicTitle={"Kąty w okręgu"} />
        ...
        <div className="col-span-full py-8 text-center">
          <div className="border-t-2 border-b-2 border-gray-300 py-4">
            ...
            <p className="text-gray-600 mt-2">
              Poznaj podstawowe własności kątów w okręgu
            </p>
          </div>
        </div>
        ...
        <div className="col-span-full py-8 text-center">
          <div className="border-t-2 border-b-2 border-gray-300 py-4">
            ...
            <p className="text-gray-600 mt-2">
              Sprawdź się w krótkich pytaniach
            </p>
          </div>
        </div>
        ...
        <div className="col-span-full py-8 text-center">
          <div className="border-t-2 border-b-2 border-gray-300 py-4">
            ...
            <p className="text-gray-600 mt-2">
              Rozwiązuj zadania wieloetapowe i maturalne
            </p>
          </div>
        </div>
      </main>
