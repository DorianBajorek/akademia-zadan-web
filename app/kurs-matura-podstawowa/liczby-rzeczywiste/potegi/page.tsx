    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        ...
        {tasks.length === 0 ? (
          ...
          <>
            <Section title="Zadania wieloetapowe" description="Do samodzielnej nauki" tasks={firstGroup} />
            <Section title="Zadania zamknięte" description="Sprawdź się!" tasks={secondGroup} />
            <Section title="Zadania otwarte" description="Zadania autorskie i maturalne" tasks={thirdGroup} />
          </>
        )}
      </main>
