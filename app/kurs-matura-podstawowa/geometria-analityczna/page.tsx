      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1">
        ...
        <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 mb-10">
          ...
          <p className="text-gray-700">
            Dział "Geometria Analityczna" to fundament matematyki. Opanowanie tych zagadnień jest
            kluczowe dla zrozumienia bardziej zaawansowanych tematów. W tym dziale poznasz
            podstawowe operacje, własności liczb i ich reprezentacje.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {topics.map((topic, index) => (
            <Link
              key={index}
              href={`/kurs-matura-podstawowa/geometria-analityczna/${topic.slug}`}
