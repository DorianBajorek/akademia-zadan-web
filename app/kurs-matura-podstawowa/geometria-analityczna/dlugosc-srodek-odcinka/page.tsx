...
const LOCAL_TASKS_META = [
  {
    id: "4200",
    title: "Zadanie 1",
    description: "Długość przekątnej kwadratu",
    img: "/problemImages/problem4200.png",
    isCompleted: false,
  },
  {
    id: "4201",
    title: "Zadanie 2",
    description: "Długość boku kwadratu",
    img: "/problemImages/problem4201.png",
    isCompleted: false,
  },
  {
    id: "4202",
    title: "Zadanie 3",
    description: "Pole trójkąta",
    img: "/problemImages/problem4202.png",
    isCompleted: false,
  },
  {
    id: "4203",
    title: "Zadanie 4",
    description: "Długość przekątnej kwadratu",
    img: "/problemImages/problem4203.png",
    isCompleted: false,
  },
  {
    id: "4204",
    title: "Zadanie 5",
    description: "Długość odcinka",
    img: "/problemImages/problem4204.png",
    isCompleted: false,
  },
];
...
const TopicTasksPage = () => {
  ...
  const firstGroup = tasks.filter(task => parseInt(task.id) >= 4200 && parseInt(task.id) < 4210);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 pt-8">
        <div className="mb-6">
          <Link 
            href="/kurs-matura-podstawowa/geometria-analityczna/" 
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 flex-1 w-full">
        <TopicStats completedCount={completedCount} totalCount={tasks.length} topicTitle={"Długość i środek odcinka"} />
