        ...
        >
          <div className="flex-1">
            <div className="flex justify-center mb-8">
              <Image src="/logoGrayBackground.svg" alt="Logo Akademii Zadań" width={200} height={200} />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-blue-800 mb-4 text-center md:text-left">
              {token ? `Witaj z powrotem, ${username}!` : "Kompleksowe przygotowanie do matury poprawkowej z matematyki"}
            </h1>
...
>
  ...
  />
        ...
        <motion.section 
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">Jak wygląda nauka w naszym kursie?</h2>
          ...
          >
            <motion.div variants={item}>
              <div className="bg-white p-6 rounded-lg shadow-lg h-full">
                ...
                <p className="text-gray-700 mb-4">
                  Kurs podzielony jest na kluczowe działy maturalne. Każdy zawiera tylko niezbędne zagadnienia.
                </p>
            ...
            <motion.div variants={item}>
              <div className="bg-white p-6 rounded-lg shadow-lg h-full">
                <h3 className="text-2xl font-semibold text-blue-600 mb-4">3. Rozwiązuj zadania krok po kroku</h3>
                <p className="text-gray-700 mb-4">
                  Ćwicz na zadaniach wieloetapowych, gdzie każde rozwiązanie jest szczegółowo wyjaśnione.
                </p>
                <div className="bg-blue-100 p-4 rounded-lg">
                  <p className="font-medium text-blue-800">Przykładowe zadanie:</p>
                  <p className="text-gray-700 mt-2">"Rozwiąż równanie kwadratowe x² - 5x + 6 = 0, a następnie podaj miejsca zerowe funkcji."</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={item}>
              <div className="bg-white p-6 rounded-lg shadow-lg h-full">
                <h3 className="text-2xl font-semibold text-blue-600 mb-4">4. Sprawdzaj się na zadaniach zamkniętych</h3>
                <p className="text-gray-700 mb-4">
                  Po opanowaniu tematu, sprawdź swoją wiedzę na typowych zadaniach zamkniętych, jakie pojawiają się na maturze.
                </p>
                <div className="bg-blue-100 p-4 rounded-lg">
                  <p className="font-medium text-blue-800">Przykładowe zadanie zamknięte:</p>
                  <p className="text-gray-700 mt-2">"Liczba rozwiązań równania 2x² - 8x + 8 = 0 wynosi: A) 0, B) 1, C) 2, D) 3"</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <motion.section 
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">Co mówią o nas uczniowie?</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold mr-4">A</div>
                <div>
                  <h4 className="font-semibold">Anna</h4>
                  <p className="text-gray-500 text-sm">Zdana matura 2025</p>
                </div>
              </div>
              <p className="text-gray-700 italic">"Dzięki temu kursowi w końcu zrozumiałam matematykę! Zadania są świetnie wytłumaczone, a filmy bardzo pomocne. Polecam każdemu, kto ma problem z matematyką!"</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold mr-4">P</div>
                <div>
                  <h4 className="font-semibold">Piotr</h4>
                  <p className="text-gray-500 text-sm">Zdana matura poprawkowa 2024</p>
                </div>
              </div>
              <p className="text-gray-700 italic">"Nie wierzyłem, że uda mi się zdać maturę, ale ten kurs pokazał mi, że to możliwe. Szczególnie pomocne były zadania z poprzednich lat - dokładnie takie same były na mojej poprawce!"</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold mr-4">M</div>
                <div>
                  <h4 className="font-semibold">Marta</h4>
                  <p className="text-gray-500 text-sm">Zdana matura poprawkowa 2024</p>
                </div>
              </div>
              <p className="text-gray-700 italic">"Kurs jest idealny dla osób, które potrzebują skupić się tylko na najważniejszych rzeczach. Zero zbędnych informacji, same konkrety. Dzięki niemu poprawiłam wynik o 40%!"</p>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <p className="text-gray-600 mt-2 mb-4">Śledź nas na social mediach, aby być na bieżąco z nowymi materiałami i poradami.</p>
