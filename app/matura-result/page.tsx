      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-10 p-6 bg-white rounded-lg shadow-md border border-gray-200">
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            Ten wynik został obliczony na podstawie 10 przykładowych zadań. Jeśli chcesz uzyskać
            dostęp do pełnego arkusza, sprawdź informacje na dole strony.
          </p>
        </div>
            ...
            <div className="mt-12">
              ...
              <div className="space-y-6">
                {storedResults.openTasks.map((task, index) => (
                  <TaskContent key={index} content={task.content} image={task.image} />
                ))}
              </div>
            </div>
          )}
        ...
        <div className="mt-16 p-6 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <p className="text-gray-700 mb-4">
            Aby otrzymać pełny arkusz maturalny wraz z omówieniem każdego zadania w formie wideo,
            szczegółowymi rozwiązaniami oraz praktycznymi wskazówkami od naszych ekspertów,
            skontaktuj się z nami. Koszt zestawu: 30 PLN. <br></br> <br></br>
            Dodatkowo oferujemy dokładne sprawdzenie zadań otwartych zgodnie z oficjalnym kluczem
            CKE – wraz z komentarzem i oceną punktową.
          </p>
          <div className="space-y-2">
            <p className="text-lg font-medium text-gray-800">
              📧 Email:{' '}
              <a href="mailto:kontakt@akademiazadan.pl" className="text-blue-600 hover:underline">
                akademiazadan@gmail.com
              </a>
            </p>
            <p className="text-lg font-medium text-gray-800">
              📞 Telefon:{' '}
              <a href="tel:+48530421473" className="text-blue-600 hover:underline">
                +48 530 421 473
              </a>
            </p>
          </div>
          <p className="mt-4 text-gray-600">Nasi konsultanci są dostępni przez całą dobę.</p>
        </div>
      </main>
    </div>
  );
