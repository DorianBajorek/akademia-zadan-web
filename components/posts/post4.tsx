      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-gray-700">
            Zadanie dotyczące przekształcenia wyrażeń trygonometrycznych jest często występującym
            zadaniem na maturze. W ostatnim czasie pojawiło się na maturach
          </p>
          ...
          pewne punkty na maturze. Jeden punkt na maturze to dwa punkty procentowe.
        </section>
        ...
        <img
          ...
          height={900}
        />
        W tym zadaniu narzuca się wzór <InlineMath math="(a-b)(a+b)=a^{2}-b^{2}" /> dla{' '}
        <InlineMath math="a=1" /> i <InlineMath math="b=\cos{20^{\circ}}" />. Po jego zastosowaniu
        dostajemy
        ...
        Widzimy tutaj, że mamym kwadraty sinusa i kosinusa, możemy więc zastosować dobrze znaną
        jedynkę trygonometryczną
        <div className="text-lg text-gray-700">
          <InlineMath math="1-\cos^{2}{20^{\circ}} - \sin^{2}{20^{\circ}}=1-(\cos^{2}{20^{\circ}} + \sin^{2}{20^{\circ}})=1-1=0" />
        </div>
        Otrzymaliśmy 0 i zaznaczamy odpowiedź B. Jest to zadanie zamknięte, możemy je spróbować
        rozwiązać trochę na skróty nie wykonując przekształceń. Taka technika jest możliwa tylko dla
        zadań zamkniętych i nie zawsze jest skuteczna. Z tablic odczytujemy, że{' '}
        <InlineMath math="\cos{20^{\circ}}=0,9397" /> oraz
        ...
        <img
          ...
          height={900}
        />
        W równaniu po lewej stronie mamy sumę dwóch ułamków. W mianownikach mamy funkcje
        trygonometryczne w kwadracie - prawdopodobnie będziemy mogli skorzystać z jedynki
        trygonometrycznej. Przekształcmy lewą stronę równania
        <div className="text-lg text-gray-700">
          <InlineMath
            math="\frac{1}{\sin^{2}{\alpha}}+\frac{1}{\cos^{2}{\alpha}}=
        ...
        Podczas przekształcania lewej strony równania sprowadziliśmy ułamki do wspólnego mianownika
        i zastosowaliśmy jedynkę trygonometryczną. W zadaniu pytają na o wartość wyrażenia{' '}
        <InlineMath math="\sin{\alpha}\cos{\alpha}" />. Szukana wartość znajduje się w naszym
        mianowniku, tylko podniesiona do kwadratu. Wyznaczmy ją z naszego równania
        <div className="text-lg text-gray-700">
        ...
        W treści zadania została podana informacje, że kąt <InlineMath math="\alpha" /> jest ostry,
        co oznacza, że jego sinus i kosinus są dodatnie. To oznacz, że ich iloczyn również jest
        dodatni. Wiedząc to, obliczamy dalej
        <div className="text-lg text-gray-700">
          <InlineMath math="\sin{\alpha} \cdot \cos{\alpha} = \frac{3}{8}" />
        </div>
        <InlineMath math="\alpha" />
        Wynik ujemny odrzuciliśmy, uzasadniając wcześniej, że dla kąta ostrego{' '}
        <InlineMath math="\alpha" /> wyrażenie
        ...
        <div className="text-lg text-gray-700">
          <InlineMath
            math="cos{\alpha}-cos{\alpha} \cdot \sin^{2}{\alpha}= 
 \cos{\alpha}(1-\sin^{2}{\alpha})   "
          />
        </div>
        Wyrażenie <InlineMath math="1-\sin^{2}{\alpha}" /> możemy wyznaczyć z jedynki
        trygonometrycznej
        <div className="text-lg text-gray-700">
        ...
        <div className="text-lg text-gray-700">
          <p>
            W wyrażeniu <InlineMath math="\sin^4 \alpha + \sin^2 \alpha \cdot \cos^2 \alpha" />{' '}
            możemy wyciągnąć wspólny czynnik <InlineMath math="\sin^{2}{\alpha}" /> przed nawias:
          </p>
          ...
          <p>
            Zatem wyrażenie <InlineMath math="\sin^4 \alpha + \sin^2 \alpha \cdot \cos^2 \alpha" />{' '}
            jest równe
          </p>
          <div className="text-lg text-gray-700">
          ...
          <p>
            Prawidłowa odpowiedź to <strong>A. </strong>.
          </p>
        </div>
      </main>
    </div>
