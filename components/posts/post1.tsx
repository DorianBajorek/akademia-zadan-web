...
const PolynomialEquationsPost: React.FC = () => {
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-gray-700">
            Równania wielomianowe to stały punkt na maturze, więc warto nauczyć się je rozwiązywać sprawnie i bez stresu. W tym wpisie pokażę Ci, jak krok po kroku radzić sobie z równaniami wymiernymi, czyli takimi, gdzie w liczniku i mianowniku występują wielomiany.

            Tego typu zadania pojawiają się niemal co roku, często jako pytania ABCD, za które możesz łatwo zdobyć cenny punkt. To raczej te prostsze przykłady, więc ich opanowanie może znacząco podnieść Twój wynik. Wystarczy znajomość podstawowych działań na ułamkach algebraicznych i równań wielomianowych – nic strasznego! Jeśli chcesz dobrze wypaść na maturze, koniecznie je przećwicz.
          </p>
        </section>

        <section className="space-y-6 mt-8">
          <h2 className="text-2xl font-bold text-blue-600">Kroki rozwiązywania równań wymiernych</h2>
          <ol className="list-decimal list-inside text-lg text-gray-700 space-y-4">
            <li><strong>Wyznacz dziedzinę:</strong> Znajdź wartości, które zerują mianownik i wyklucz je z dziedziny.</li>
            <li><strong>Rozwiąż równanie:</strong> Przyrównaj licznik do zera i rozwiąż otrzymane równanie.</li>
            <li><strong>Sprawdź rozwiązania:</strong> Upewnij się, że rozwiązania należą do dziedziny.</li>
          </ol>
        </section>
        ...
        <section className="space-y-6 mt-8">
          ...
          <p className="text-lg text-gray-700">
            <strong>Krok 1: Wyznacz dziedzinę</strong><br />
          ...
          <p className="text-lg text-gray-700">
            <strong>Krok 2: Rozwiąż równanie</strong><br />
          ...
          <p className="text-lg text-gray-700">
            <strong>Krok 3: Sprawdź rozwiązanie</strong><br />
            Sprawdzamy, czy <InlineMath math="x = -1" /> należy do dziedziny. Ponieważ <InlineMath math="-1 \neq -2 \text{ oraz } -1 \neq 3" />, rozwiązanie jest poprawne.
          </p>
          <p className="text-lg text-gray-700">
            <strong>Odpowiedź:</strong> Równanie ma dokładnie jedno rozwiązanie: <InlineMath math="-1" />.
          </p>
        </section>
  ...
  <div className="text-lg text-gray-700">
    <strong>Krok 3: Sprawdź rozwiązania</strong><br />
    Sprawdzamy, czy rozwiązania należą do dziedziny:
    <ul className="list-disc list-inside text-lg text-gray-700">
      <li><InlineMath math="x = 0" /> należy do dziedziny.</li>
      <li><InlineMath math="x = -5" /> należy do dziedziny.</li>
      <li><InlineMath math="x = 2" /> należy do dziedziny.</li>
      <li><InlineMath math="x = -2" /> nie należy do dziedziny.</li>
    </ul>
  </div>
  <p className="text-lg text-gray-700">
    <strong>Odpowiedź:</strong> Równanie ma dokładnie trzy rozwiązania: <InlineMath math="-5" />, <InlineMath math="0" /> oraz <InlineMath math="2" />.
  </p>
  <p className="text-lg text-gray-700">
    <strong>Poprawna odpowiedź:</strong> C. trzy rozwiązania: <InlineMath math="-5" />, <InlineMath math="0" /> oraz <InlineMath math="2" />.
  </p>
</section>
      </main>
    </div>
