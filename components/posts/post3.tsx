  ...
  return (
    <div className="min-h-screen">
      <main className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-center text-blue-600 mb-8">Działania na potęgach</h1>
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-gray-700">
            Zadanie polegające na upraszczanie potęg i pierwiastków pojawiają się na wielu maturach.
            To zazwyczaj zadania zamknięte. Wymagają one podstawowych umiejętności działania na
            potęgach.
          </p>
        ...
        <section className="space-y-6 mt-8">
          ...
          W tej sekcji przypomnimy podstawowe własności działania na pierwiastkach i potęgach. Warto
          zajrzeć do karty wzorów i sprawdzić jakie tam można znaleźć wzory w tym zakresie.
          <img
          ...
          Zaczniemy od <InlineMath math="\sqrt[5]{5}" />. Zgodnie ze wzorem{' '}
          <InlineMath math="\sqrt[m]{a}=a^{\frac{1}{m}}" />
          zapisujemy, że <InlineMath math="\sqrt[5]{5}=5^{\frac{1}{5}}" />. Liczbę{' '}
          <InlineMath math="\frac{1}{5}" /> przekształcamy ze znanej własności{' '}
          <InlineMath math="\frac{1}{a}=a^{-1}" /> czyli <InlineMath math="\frac{1}{5}=5^{-1}" />.
          ...
          Skorzystaliśmy tutaj z własności <InlineMath math="a^{m} \cdot a^{n}=a^{m+n}" />. Kolejną
          własnością, jaką wykorzstamy jest <InlineMath math="(a^{n})^{m}=a^{n \cdot m}" />. Po
          przekształceniu nawiasu wykonujemy ostatnie przekształcenie
          <div className="text-lg text-gray-700">
        ...
        znanych kwadratów, czyli <InlineMath math="4=2^{2}" /> i <InlineMath math="25=5^{2}" />.
        ...
        <InlineMath math="(a^{n})^{m}=a^{n \cdot m}" />
        <div className="text-lg text-gray-700">
        ...
        <InlineMath math="( 2^{-1} \cdot 32^{\frac{3}{5}})" />. Skorzystamy z własności potęgowania,
        aby uprościć obie części wyrażenia. Najpierw uprościmy{' '}
        <InlineMath math="( 32^{\frac{3}{5}} )" />. Wiemy, że <InlineMath math="( 32 = 2^5 )" />,
        więc możemy zapisać:
        <div className="text-lg text-gray-700">
        ...
        <InlineMath math="81 = 9 \cdot 9 = 3^{2} \cdot 3^{2} = 3^{4}" />. Zawsze zamieniamy liczby
        na najmniejszą podstawą którą możemy uzyskać, dlatego wybraliśmy 3. Dale przekształcamy
        ułamek zaczynając od mianownika
        <div className="text-lg text-gray-700">
          <InlineMath math="(-\frac{1}{9})^{-2}=(-\frac{1}{3^{2}})^{-2}=(-3^{-2})^{-2}=3^{(-2) \cdot (-2)}=3^{4}" />
        </div>
        Wykoszystaliśmy tutaj własność, że liczba ujemna podniesiona do kwadratu staje się liczbą
        dodatnią. Przekształcamy dalej nasze wyrażenie, wykorzystując to co otrzymaliśmy
        <div className="text-lg text-gray-700">
