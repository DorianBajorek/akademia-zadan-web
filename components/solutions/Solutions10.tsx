...
const Solution10 = () => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <p className="mb-2">
        Zauważamy, że <InlineMath math="\sin 20^\circ" /> jest wspólnym czynnikiem obu składników.
        Wyciągamy go przed nawias:
      </p>
      ...
      <p className="mb-2">Wiemy, że jedynka trygonometryczna mówi:</p>
      ...
      <p className="mb-2">Podstawiamy jedynkę trygonometryczną do wyrażenia:</p>
      <BlockMath math="\sin 20^\circ \cdot 1 = \sin 20^\circ" />

      <h2 className="text-xl font-semibold mt-4 mb-2">Odpowiedź</h2>
      <p className="text-lg font-bold text-green-600">
        Wartość wyrażenia{' '}
        <InlineMath math="\sin^3 20^\circ + \cos^2 20^\circ \cdot \sin 20^\circ" /> jest równa{' '}
        <InlineMath math="\sin 20^\circ" /> (odpowiedź <strong>B</strong>).
      </p>
    </div>
  );
};
