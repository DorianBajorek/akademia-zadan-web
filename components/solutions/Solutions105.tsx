  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Funkcja <InlineMath math="f" /> jest określona wzorem <InlineMath math="f(x) = 4^{-x} + 1" /> dla każdej liczby rzeczywistej <InlineMath math="x" />. Liczba <InlineMath math="f\left(\frac{1}{2}\right)" /> jest równa
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="17" /></p>
        </div>
      </div>
