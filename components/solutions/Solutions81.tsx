  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Pole pewnego trójkąta równobocznego jest równe <InlineMath math="\frac{4\sqrt{3}}{9}" />. Obwód tego trójkąta jest równy
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="\frac{4}{3}" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Wzór na pole trójkąta równobocznego</h2>
      <p className="mb-2">
