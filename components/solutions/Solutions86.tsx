  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Pole figury <InlineMath math="F_1" /> złożonej z dwóch stycznych zewnętrznie kół o promieniach <InlineMath math="1" /> i <InlineMath math="3" /> jest równe polu figury <InlineMath math="F_2" /> złożonej z dwóch stycznych zewnętrznie kół o promieniach długości <InlineMath math="r" />. Długość <InlineMath math="r" /> promienia jest równa
      </div>

      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ A:</strong> <InlineMath math="\sqrt{3}" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="2" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="\sqrt{5}" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 3: Przyrównanie pól i rozwiązanie równania</h2>
      <p className="mb-2">
      ...
      <p className="text-lg font-bold text-green-600">
        Długość promienia <InlineMath math="r" /> wynosi <InlineMath math="\sqrt{5}" /> (odpowiedź <strong>C</strong>).
      </p>
    </div>
  );
};
