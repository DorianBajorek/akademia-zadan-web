  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Wysokość trójkąta równobocznego jest równa <InlineMath math="6\sqrt{3}" />. Pole tego
        trójkąta jest równe:
      </div>
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="3\sqrt{3}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="4\sqrt{3}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="27\sqrt{3}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="36\sqrt{3}" />
          </p>
        </div>
      </div>

      <h2 className="text-xl font-semibold mt-4 mb-2">
        Krok 1: Związek między wysokością a bokiem trójkąta równobocznego
      </h2>
      <p className="mb-2">
        W trójkącie równobocznym wysokość <InlineMath math="h" /> jest związana z długością boku{' '}
        <InlineMath math="a" /> wzorem:
      </p>
      <BlockMath math="h = \frac{a\sqrt{3}}{2}" />
      <p className="mb-2">Podstawiamy znaną wysokość:</p>
      ...
      <p className="mb-2">Pole trójkąta równobocznego obliczamy ze wzoru:</p>
