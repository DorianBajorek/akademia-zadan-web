  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="\sqrt{3}" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Zapisanie logarytmu w postaci potęgowej</h2>
      <p className="mb-2">
        Logarytm <InlineMath math="\log_{\sqrt{3}} 3" /> oznacza, że szukamy wykładnika <InlineMath math="x" />, dla którego:
      </p>
      <BlockMath math="(\sqrt{3})^x = 3" />

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Przekształcenie pierwiastka do postaci potęgi</h2>
      <p className="mb-2">
        Pierwiastek <InlineMath math="\sqrt{3}" /> można zapisać jako <InlineMath math="3^{\frac{1}{2}}" />. Zatem równanie przyjmuje postać:
      </p>
      ...
      <p className="text-lg font-bold text-green-600">
        Liczba <InlineMath math="\log_{\sqrt{3}} 3" /> jest równa <InlineMath math="2" /> (odpowiedź <strong>B</strong>).
      </p>
    </div>
  );
};
