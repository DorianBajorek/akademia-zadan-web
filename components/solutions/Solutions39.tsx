  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{9}{2}" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
      ...
      <p className="mb-2">
        Miejsce zerowe funkcji <InlineMath math="f" /> to wartość <InlineMath math="x" />, dla której <InlineMath math="f(x) = 0" />. Rozwiązujemy równanie:
      </p>
      ...
      <p className="text-lg font-bold text-green-600">
        Miejscem zerowym funkcji <InlineMath math="f" /> jest liczba <InlineMath math="12" /> (odpowiedź <strong>D</strong>).
      </p>
    </div>
  );
};
