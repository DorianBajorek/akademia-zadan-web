  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Równanie
        <BlockMath math="\frac{(x+1)(x-1)^2}{(x-1)(x+1)^2} = 0" />w zbiorze liczb rzeczywistych:
      </div>
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> ma dokładnie jedno rozwiązanie: <InlineMath math="1" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> ma dokładnie dwa rozwiązania: <InlineMath math="-1" />{' '}
            oraz <InlineMath math="1" />
          </p>
        </div>
      </div>
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Określenie dziedziny równania</h2>
      <p className="mb-2">Równanie ma sens, gdy mianownik nie jest równy zero. Zatem:</p>
      ...
      <p className="mb-2">
        Rozwiązania to <InlineMath math="x = -1" /> i <InlineMath math="x = 1" />. Jednak z
        dziedziny wiemy, że <InlineMath math="x \neq 1" /> i <InlineMath math="x \neq -1" />.
      </p>
