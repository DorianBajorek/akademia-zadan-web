  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Zbiorem wszystkich rozwiązań nierówności <InlineMath math="\frac{2-x}{2} - 2x \geq 1" />{' '}
        jest przedział:
      </div>
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="[0, +\infty)" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="(-\infty, 0]" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="(-\infty, 5]" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="(-\infty, \frac{1}{3}]" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">Najpierw mnożymy obie strony przez 2, aby pozbyć się ułamka:</p>
      ...
      <p className="mb-2">Łączymy podobne wyrazy:</p>
      <BlockMath math="2 - 5x \geq 2" />
      <p className="mb-2">Odejmujemy 2 od obu stron:</p>
      ...
      <p className="text-lg font-bold text-green-600">
        Zbiór rozwiązań nierówności to <InlineMath math="(-\infty, 0]" /> (odpowiedź{' '}
        <strong>B</strong>).
      </p>
    </div>
  );
