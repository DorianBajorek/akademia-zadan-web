  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Dany jest równoległobok o bokach długości <InlineMath math="3" /> i <InlineMath math="4" />{' '}
        oraz o kącie między nimi o mierze <InlineMath math="120^\circ" />. Pole tego równoległoboku
        jest równe:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="12\sqrt{3}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="6" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="6\sqrt{3}" />
          </p>
        </div>
      </div>
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>
          <InlineMath math="a" /> i <InlineMath math="b" /> to długości boków równoległoboku,
        </li>
        <li>
          <InlineMath math="\theta" /> to kąt między tymi bokami.
        </li>
      </ul>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Podstawienie danych</h2>
      <p className="mb-2">Dla danego równoległoboku:</p>
      ...
      <p className="mb-2">Podstawiamy wartość sinusa do wzoru:</p>
