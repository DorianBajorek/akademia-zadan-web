  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Proste o równaniach <InlineMath math="y = 3x - 5" /> oraz{' '}
        <InlineMath math="y = \frac{m-3}{2}x + \frac{9}{2}" /> są równoległe, gdy:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="m = 6" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="m = 9" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Dwie proste są równoległe, gdy ich współczynniki kierunkowe są równe. Porównujemy
      ...
      <p className="mb-2">Dodajemy 3 do obu stron:</p>
      <BlockMath math="m = 9" />
