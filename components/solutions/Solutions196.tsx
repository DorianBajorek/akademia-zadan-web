  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Dane są dwa okręgi: okrąg o środku w punkcie <InlineMath math="O" /> i promieniu <InlineMath math="5" /> oraz okrąg o środku w punkcie <InlineMath math="P" /> i promieniu <InlineMath math="3" />. Odcinek <InlineMath math="OP" /> ma długość <InlineMath math="16" />. Prosta <InlineMath math="AB" /> jest styczna do tych okręgów w punktach <InlineMath math="A" /> i <InlineMath math="B" />. Ponadto prosta <InlineMath math="AB" /> przecina odcinek <InlineMath math="OP" /> w punkcie <InlineMath math="K" /> (zobacz rysunek). Wtedy
      </div>
      ...
      <ul className="list-disc pl-5 mb-2">
        <li>Okrąg większy: środek <InlineMath math="O" />, promień <InlineMath math="5" /></li>
        <li>Okrąg mniejszy: środek <InlineMath math="P" />, promień <InlineMath math="3" /></li>
      </ul>
      <p className="mb-2">
        Odcinek <InlineMath math="OP" /> ma długość <InlineMath math="16" />. Prosta styczna <InlineMath math="AB" /> dotyka obu okręgów odpowiednio w punktach <InlineMath math="A" /> i <InlineMath math="B" />.
      </p>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Wykorzystanie podobieństwa trójkątów</h2>
      <p className="mb-2">
        Trójkąty <InlineMath math="OAK" /> i <InlineMath math="PBK" /> są podobne (oba są prostokątne i mają wspólny kąt przy wierzchołku <InlineMath math="K" />). Zatem:
      </p>
