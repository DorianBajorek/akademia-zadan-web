  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Punkty <InlineMath math="A = (-4, 4)" /> i <InlineMath math="B = (4, 0)" /> są sąsiednimi
        wierzchołkami kwadratu <InlineMath math="ABCD" />. Przekątna tego kwadratu ma długość:
      </div>

      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="4\sqrt{10}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="4\sqrt{2}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="4\sqrt{5}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="4\sqrt{7}" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Najpierw obliczamy długość boku kwadratu, korzystając ze wzoru na odległość między dwoma
        punktami:
      </p>
      <BlockMath math="|AB| = \sqrt{(x_B - x_A)^2 + (y_B - y_A)^2}" />
      <p className="mb-2">
        Podstawiamy współrzędne punktów <InlineMath math="A = (-4, 4)" /> i{' '}
        <InlineMath math="B = (4, 0)" />:
      </p>
