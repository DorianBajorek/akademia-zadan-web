  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Proste o równaniach <InlineMath math="y = (2m + 2)x - 2019" /> oraz <InlineMath math="y = (3m - 3)x + 2019" /> są równoległe, gdy:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="m = 0" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
      ...
      <p className="mb-2">
        Dwie proste są równoległe, jeśli ich współczynniki kierunkowe są równe. Współczynniki kierunkowe prostych to:
      </p>
