...
const Solution37 = () => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <p className="mb-2">
        Aby pozbyć się ułamków, mnożymy obie strony nierówności przez 15 (najmniejszą wspólną wielokrotność mianowników 5 i 3):
      </p>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 3: Przeniesienie wyrazów z <InlineMath math="x" /> na jedną stronę</h2>
      <p className="mb-2">
        Przenosimy wszystkie wyrazy zawierające <InlineMath math="x" /> na lewą stronę, a stałe na prawą:
      </p>
      <BlockMath math="6 > 5x + 3x" />
      <BlockMath math="6 > 8x" />
