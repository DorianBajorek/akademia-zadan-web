  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="5" />
          </p>
        </div>
      </div>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Uproszczenie wyrażenia</h2>
      <p className="mb-2">Najpierw upraszczamy każdy z logarytmów:</p>
      ...
      <p className="mb-2">Suma wyrażeń to:</p>
      ...
      <p className="text-lg font-bold text-green-600">
        Suma <InlineMath math="2 \log \sqrt{10} + \log 10^3" /> jest równa <InlineMath math="4" />{' '}
