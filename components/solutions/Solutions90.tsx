  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Sześciowyrazowy ciąg liczbowy <InlineMath math="(1, 2, 2x, x + 2, 5, 6)" /> jest niemalejący.  
        Mediana wyrazów tego ciągu jest równa 4. Wynika stąd, że:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="x = \frac{3}{2}" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="x = 2" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="x = \frac{8}{3}" /></p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Zgodnie z treścią zadania mediana wynosi 4:
      </p>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 4: Sprawdzenie warunku niemalejącego ciągu</h2>
      <p className="mb-2">
        Dla <InlineMath math="x = 2" /> ciąg wygląda następująco:
      </p>
      <BlockMath math="1, 2, 4, 4, 5, 6" />
      <p className="mb-2">
        Ciąg jest niemalejący, więc warunek jest spełniony.
      </p>
