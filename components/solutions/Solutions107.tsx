  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        W ciągu arytmetycznym <InlineMath math="(a_n)" />, określonym dla <InlineMath math="n \geq 1" />, czwarty wyraz jest równy 3, a różnica tego ciągu jest równa 5. Suma <InlineMath math="a_1 + a_2 + a_3 + a_4" /> jest równa:
      </div>

      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ A:</strong> <InlineMath math="-42" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="6" /></p>
        </div>
      </div>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Wyznaczenie pierwszego wyrazu ciągu</h2>
      <p className="mb-2">
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Wyznaczenie kolejnych wyrazów ciągu</h2>
      <p className="mb-2">
      ...
      <p className="text-lg font-bold text-green-600">
        Suma <InlineMath math="a_1 + a_2 + a_3 + a_4" /> jest równa <InlineMath math="-18" /> (odpowiedź <strong>C</strong>).
      </p>
    </div>
  );
};
