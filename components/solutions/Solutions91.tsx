  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Wartość wyrażenia <InlineMath math="x^2 - 6x + 9" /> dla{' '}
        <InlineMath math="x = \sqrt{3} + 3" /> jest równa
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="1 + 2\sqrt{3}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="1 - 2\sqrt{3}" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">Obliczamy kwadrat pierwiastka:</p>
