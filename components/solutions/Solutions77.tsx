  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        ...
        Trzeci i piąty wyraz ciągu spełniają warunek <InlineMath math="a_3 + a_5 = 58" />. Wtedy czwarty wyraz tego ciągu jest równy:
      </div>

      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ A:</strong> <InlineMath math="28" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="29" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="33" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="40" /></p>
        </div>
      </div>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Wyrażenie wyrazów ciągu</h2>
      <p className="mb-2">
        W ciągu arytmetycznym wyrazy można wyrazić jako:
      </p>
      ...
      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Wyrażenie  <InlineMath math="a_3" /> i  <InlineMath math="a_5" /></h2>
      <p className="mb-2">
