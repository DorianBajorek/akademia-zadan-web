  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Trzywyrazowy ciąg <InlineMath math="(27, 9, a - 1)" /> jest geometryczny. Liczba <InlineMath math="a" /> jest równa:
      </div>
      ...
      <p className="mb-2">
        W ciągu geometrycznym dla trzech kolejnych wyrazów zachodzi:
      </p>
      <BlockMath math="(a_2)^2 = a_1 \cdot a_3" />
      <p className="mb-2">
        Podstawiamy wyrazy ciągu:
      </p>
      ...
      <p className="text-lg font-bold text-green-600">
        Liczba <InlineMath math="a" /> jest równa <InlineMath math="4" /> (odpowiedź <strong>C</strong>).
      </p>
    </div>
  );
};
