  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Promień <InlineMath math="AS" /> podstawy walca jest równy wysokości{' '}
        <InlineMath math="OS" /> tego walca. Sinus kąta <InlineMath math="OAS" /> (zobacz rysunek)
        jest równy
      </div>
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="\frac{\sqrt{3}}{2}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{\sqrt{2}}{2}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="\frac{1}{2}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
      ...
      <p className="mb-2">
        Trójkąt <InlineMath math="OAS" /> jest prostokątny w punkcie <InlineMath math="S" />,
        ponieważ wysokość walca jest prostopadła do podstawy.
      </p>
      <p className="mb-2">
      ...
      <p className="text-lg font-bold text-green-600">
        Sinus kąta <InlineMath math="OAS" /> wynosi <InlineMath math="\frac{\sqrt{2}}{2}" />{' '}
