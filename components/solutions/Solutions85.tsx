  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        W każdym <InlineMath math="n" />
        -kącie wypukłym (<InlineMath math="n \geq 3" />) liczba przekątnych jest równa{' '}
        <InlineMath math="\frac{n(n-3)}{2}" />. Wielokątem wypukłym, w którym liczba przekątnych
        jest o 25 większa od liczby boków, jest:
      </div>

      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> siedmiokąt
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> dziesięciokąt
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> dwunastokąt
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> piętnastokąt
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">Mnożymy obie strony przez 2, aby pozbyć się ułamka:</p>
      <BlockMath math="n(n - 3) = 2n + 50" />
      <p className="mb-2">Rozwijamy i porządkujemy równanie:</p>
      <BlockMath math="n^2 - 3n = 2n + 50" />
      <BlockMath math="n^2 - 5n - 50 = 0" />
      <p className="mb-2">Rozwiązujemy równanie kwadratowe:</p>
      ...
      <p className="text-lg font-bold text-green-600">
        ...
        <strong>dziesięciokąt</strong> (odpowiedź <strong>B</strong>).
      </p>
    </div>
  );
};
