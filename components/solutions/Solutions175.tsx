    ...
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ A:</strong> prawdziwa dla <InlineMath math="x = -\sqrt{2}" />.</p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> prawdziwa dla <InlineMath math="x = \sqrt{2}" />.</p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> prawdziwa dla <InlineMath math="x = -1" />.</p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> fałszywa dla każdej liczby <InlineMath math="x" />.</p>
        </div>
      </div>
      ...
      <ul className="list-disc pl-5 mb-2">
        <li>Dla <InlineMath math="x = -1" />: <InlineMath math="(-1\cdot\sqrt{2} - 2)^2 = (-\sqrt{2} - 2)^2 = (2 + \sqrt{2})^2" /> - prawda</li>
      </ul>
