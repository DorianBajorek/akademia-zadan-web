  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Dany jest romb o boku długości 4 i kącie rozwartym <InlineMath math="150^\circ" />. Pole
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="12" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="8\sqrt{3}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
      ...
      <p className="mb-2">
        gdzie <InlineMath math="a" /> to długość boku rombu, a <InlineMath math="\alpha" /> to miara
        kąta ostrego lub rozwartego.
      </p>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Obliczenie sinusa kąta</h2>
      <p className="mb-2">
        Kąt rozwarty rombu wynosi <InlineMath math="150^\circ" />. Obliczamy{' '}
        <InlineMath math="\sin(150^\circ)" />:
      </p>
      ...
      <p className="mb-2">Podstawiamy wartości do wzoru na pole rombu:</p>
