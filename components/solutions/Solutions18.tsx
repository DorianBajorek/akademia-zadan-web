  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Dla każdej liczby rzeczywistej <InlineMath math="a" /> wyrażenie{' '}
        <InlineMath math="(2a - 3)^2 - (2a + 3)^2" /> jest równe:
      </div>

      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="-24a" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="16a^2 - 24a" />
          </p>
        </div>
      </div>
      ...
      <p className="text-lg font-bold text-green-600">
        Wartość wyrażenia <InlineMath math="(2a - 3)^2 - (2a + 3)^2" /> jest równa{' '}
        <InlineMath math="-24a" /> (odpowiedź <strong>A</strong>).
      </p>
    </div>
  );
};
