  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        W trójkącie <InlineMath math="ABC" /> bok <InlineMath math="BC" /> ma długość{' '}
        <InlineMath math="13" />, a wysokość <InlineMath math="CD" /> tego trójkąta dzieli bok{' '}
        <InlineMath math="AB" /> na odcinki o długościach <InlineMath math="|AD| = 3" /> i{' '}
        <InlineMath math="|BD| = 12" />. Długość boku <InlineMath math="AC" /> jest równa
      </div>
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="\sqrt{34}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{13}{4}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="2\sqrt{14}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="3\sqrt{45}" />
          </p>
        </div>
      </div>
      ...
      <p className="text-lg font-bold text-green-600">
        Długość boku <InlineMath math="AC" /> wynosi <InlineMath math="\sqrt{34}" /> (odpowiedź{' '}
        <strong>A</strong>).
      </p>
    </div>
  );
