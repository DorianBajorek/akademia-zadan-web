  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Średnia arytmetyczna zestawu sześciu liczb: <InlineMath math="2x, 4, 6, 8, 11, 13" />, jest równa 5.  
        Wynika stąd, że:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="x = 7" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="x = -6" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="x = 6" /></p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Suma liczb w zestawie to:
      </p>
      <BlockMath math="2x + 4 + 6 + 8 + 11 + 13 = 30" />
      <p className="mb-2">
        Obliczamy sumę znanych liczb:
      </p>
