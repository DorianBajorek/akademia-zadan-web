  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        ...
        <InlineMath math="n \geq 1" />. Wszystkie wyrazy tego ciągu są dodatnie i spełniony jest
        warunek:
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{1}{\sqrt{3}}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="\sqrt{3}" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">
        W ciągu geometrycznym każdy wyraz jest iloczynem poprzedniego wyrazu i ilorazu{' '}
        <InlineMath math="q" />. Mamy:
      </p>
      ...
      <p className="mb-2">Z warunku zadania:</p>
      <BlockMath math="\frac{a_5}{a_3} = \frac{1}{9}" />
      <p className="mb-2">
      ...
      <BlockMath math="q^{2} = \frac{1}{9}" />
      <p className="mb-2">
        Ponieważ wszystkie wyrazy ciągu są dodatnie, iloraz <InlineMath math="q" /> również musi być
        dodatni. Zatem:
      </p>
