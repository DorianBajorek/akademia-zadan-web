  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        W kartezjańskim układzie współrzędnych <InlineMath math="(x, y)" /> proste{' '}
        <InlineMath math="k" /> oraz <InlineMath math="l" /> są określone równaniami:
        <BlockMath math="k : y = (m + 1)x + 7" />
        <BlockMath math="l : y = -2x + 7" />
        Proste <InlineMath math="k" /> oraz <InlineMath math="l" /> są prostopadłe, gdy liczba{' '}
        <InlineMath math="m" /> jest równa:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{1}{2}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
      ...
      <p className="mb-2">
        Dwie proste są prostopadłe, jeśli iloczyn ich współczynników kierunkowych jest równy{' '}
        <InlineMath math="-1" />. Dla prostych:
      </p>
      <BlockMath math="k : y = a_1 x + b_1" />
      <BlockMath math="l : y = a_2 x + b_2" />
      <p className="mb-2">Warunek prostopadłości ma postać:</p>
      ...
      <p className="mb-2">Podstawiamy do warunku prostopadłości:</p>
      ...
      <p className="text-lg font-bold text-green-600">
        Liczba <InlineMath math="m" /> jest równa <InlineMath math="-\frac{1}{2}" /> (odpowiedź{' '}
        <strong>A</strong>).
      </p>
    </div>
  );
