      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> Rysunek A
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> Rysunek B
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> Rysunek C
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> Rysunek D
          </p>
        </div>
      </div>

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 1: Rozwiązanie nierówności</h2>
      <p className="mb-2">Rozwiążmy nierówność krok po kroku:</p>
      <BlockMath math="2 - 3x \geq 4" />
      <BlockMath math="-3x \geq 4 - 2" />
      <BlockMath math="-3x \geq 2" />
      <p className="mb-2">Przy dzieleniu przez liczbę ujemną zmieniamy znak nierówności:</p>
      <BlockMath math="x \leq -\frac{2}{3}" />

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Interpretacja rozwiązania</h2>
      <p className="mb-2">
        Rozwiązaniem nierówności są wszystkie liczby rzeczywiste mniejsze lub równe{' '}
        <InlineMath math="-\frac{2}{3}" />. Na osi liczbowej odpowiada to:
      </p>
      <ul className="list-disc pl-5 mb-2">
        <li>
          Zaznaczeniu punktu <InlineMath math="-\frac{2}{3}" />
        </li>
        <li>Pogrubionej linii ciągnącej się w lewo od tego punktu</li>
        <li>
          Zamalowanemu kółku w punkcie <InlineMath math="-\frac{2}{3}" /> (bo nierówność jest
          nieostra)
        </li>
      </ul>
