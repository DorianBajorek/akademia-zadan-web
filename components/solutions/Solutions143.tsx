...
const Solution = () => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ A:</strong> <InlineMath math="\frac{1}{8}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{1}{5}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="\frac{1}{40}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="\frac{1}{35}" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Prawdopodobieństwo wylosowania kuli czerwonej obliczamy jako stosunek liczby kul czerwonych
        do liczby wszystkich kul:
      </p>
      <BlockMath math="P(\text{czerwona}) = \frac{\text{liczba kul czerwonych}}{\text{liczba wszystkich kul}} = \frac{5}{40}" />
      <p className="mb-2">Upraszczamy ułamek:</p>
      <BlockMath math="\frac{5}{40} = \frac{1}{8}" />

      <h2 className="text-xl font-semibold mt-4 mb-2">Odpowiedź</h2>
      <p className="text-lg font-bold text-green-600">
        Prawdopodobieństwo wylosowania kuli czerwonej wynosi <InlineMath math="\frac{1}{8}" />{' '}
