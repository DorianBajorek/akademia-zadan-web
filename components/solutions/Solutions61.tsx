  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Liczba <InlineMath math="\sin^3 20^\circ + \cos^2 20^\circ \cdot \sin 20^\circ" /> jest równa:
      </div>
      ...
      <p className="text-lg font-bold text-green-600">
        Liczba <InlineMath math="\sin^3 20^\circ + \cos^2 20^\circ \cdot \sin 20^\circ" /> jest równa <InlineMath math="\sin 20^\circ" /> (odpowiedź <strong>B</strong>).
      </p>
    </div>
  );
};
