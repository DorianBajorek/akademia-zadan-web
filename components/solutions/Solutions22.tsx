  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Jednym z miejsc zerowych funkcji kwadratowej <InlineMath math="f" /> jest liczba <InlineMath math="-5" />. Pierwsza współrzędna wierzchołka paraboli, będącej wykresem funkcji <InlineMath math="f" />, jest równa <InlineMath math="3" />. Drugim miejscem zerowym funkcji <InlineMath math="f" /> jest liczba:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="-13" /></p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Odległość między miejscem zerowym <InlineMath math="-5" /> a wierzchołkiem <InlineMath math="3" /> wynosi:
      </p>
      ...
      <p className="text-lg font-bold text-green-600">
        Drugim miejscem zerowym funkcji <InlineMath math="f" /> jest liczba <InlineMath math="1" /> (odpowiedź <strong>A</strong>).
      </p>
    </div>
  );
};
