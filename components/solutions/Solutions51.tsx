    ...
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      ...
      <div className="space-y-3 mb-6">
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ A:</strong> <InlineMath math="560 \text{ cm}^3" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="280 \text{ cm}^3" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="280 \text{ cm}^3" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ D:</strong> <InlineMath math="560 \text{ cm}^3" /></p>
        </div>
      </div>
      ...
      <p className="mb-2">
        gdzie <InlineMath math="d_1" /> i <InlineMath math="d_2" /> to długości przekątnych. Podstawiamy wartości:
      </p>
      <BlockMath math="P = \frac{7 \cdot 10}{2} = 35 \text{ cm}^2" />

      <h2 className="text-xl font-semibold mt-4 mb-2">Krok 2: Obliczenie wysokości graniastosłupa</h2>
      <p className="mb-2">
      ...
      <p className="text-lg font-bold text-green-600">
        Objętość graniastosłupa jest równa <InlineMath math="280 \text{ cm}^3" /> (odpowiedź <strong>B</strong>).
      </p>
    </div>
  );
};
