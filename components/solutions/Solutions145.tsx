  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Promień kuli i promień podstawy stożka są równe 5. Pole powierzchni kuli jest równe polu powierzchni całkowitej stożka. Długość tworzącej stożka jest równa:
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ B:</strong> <InlineMath math="5" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold"><strong>ODPOWIEDŹ C:</strong> <InlineMath math="15" /></p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
      ...
      <p className="mb-2">
        Gdzie <InlineMath math="r" /> to promień podstawy, a <InlineMath math="l" /> to długość tworzącej stożka. Podstawiamy <InlineMath math="r = 5" />:
      </p>
      ...
      <p className="mb-2">
        Zgodnie z treścią zadania pola powierzchni są równe:
      </p>
