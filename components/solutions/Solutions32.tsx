  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        ...
        <InlineMath math="2x = 3y" />. Wynika stąd, że wartość wyrażenia
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ B:</strong> <InlineMath math="\frac{13}{6}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ C:</strong> <InlineMath math="\frac{6}{13}" />
          </p>
        </div>
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="\frac{3}{2}" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">
        Z warunku <InlineMath math="2x = 3y" /> możemy wyrazić <InlineMath math="x" /> przez{' '}
        <InlineMath math="y" />:
      </p>
      ...
      <p className="mb-2">
        Podstawiamy <InlineMath math="x = \frac{3}{2}y" /> do wyrażenia{' '}
        <InlineMath math="\frac{x^2 + y^2}{xy}" />:
      </p>
      ...
      <p className="text-lg font-bold text-green-600">
        Wartość wyrażenia <InlineMath math="\frac{x^2 + y^2}{xy}" /> jest równa{' '}
        <InlineMath math="\frac{13}{6}" /> (odpowiedź <strong>B</strong>).
      </p>
    </div>
  );
};
