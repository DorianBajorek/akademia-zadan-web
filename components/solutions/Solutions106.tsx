  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Ciąg <InlineMath math="(a_n)" /> jest określony wzorem <InlineMath math="a_n = 2n^2" /> dla{' '}
        <InlineMath math="n \geq 1" />. Różnica <InlineMath math="a_5 - a_4" /> jest równa
      </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <p className="font-semibold">
            <strong>ODPOWIEDŹ D:</strong> <InlineMath math="18" />
          </p>
        </div>
      </div>
      ...
      <p className="mb-2">Obliczamy różnicę między wyrazami:</p>
      <BlockMath math="a_5 - a_4 = 50 - 32 = 18" />

      <h2 className="text-xl font-semibold mt-4 mb-2">Weryfikacja</h2>
      <p className="mb-2">Możemy też użyć ogólnego wzoru na różnicę:</p>
