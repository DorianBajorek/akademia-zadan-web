  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-300 mt-16">
      <div className="text-lg mb-4">
        Liczba <InlineMath math="1" /> jest miejscem zerowym funkcji liniowej{' '}
        <InlineMath math="f(x) = ax + b" />, a punkt <InlineMath math="M = (3, -2)" /> należy do
        wykresu tej funkcji. Współczynnik <InlineMath math="a" /> we wzorze tej funkcji jest równy:
      </div>
      ...
      <p className="mb-2">
        Skoro <InlineMath math="1" /> jest miejscem zerowym funkcji{' '}
        <InlineMath math="f(x) = ax + b" />, to:
      </p>
      ...
      <p className="mb-2">Otrzymujemy równanie:</p>
      <BlockMath math="a + b = 0 \quad \Rightarrow \quad b = -a" />

      <h2 className="text-xl font-semibold mt-4 mb-2">
        Krok 2: Wykorzystanie punktu <InlineMath math="M = (3, -2)" />
      </h2>
      <p className="mb-2">
