...
const Page = () => {
  ...
  const handleStageComplete = (stage: number) => {
    setCompletedStages((prev) => {
      ...
      if (updated.length === 6 && !problemSolved) {
    ...
    <div className="min-h-screen p-5">
      <div className="max-w-3xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        <p className="text-lg text-gray-800 mt-4">
          Rozważamy wszystkie prostopadłościany <InlineMath math="ABCDEFGH" />, w których krawędź{' '}
          <InlineMath math="AE" /> jest <InlineMath math="3" /> razy dłuższa od krawędzi{' '}
          <InlineMath math="AB" />, a suma długości wszystkich dwunastu krawędzi prostopadłościanu
          jest równa <InlineMath math="48" />.
        </p>
        <p className="text-lg text-gray-800 mt-4">
          Niech <InlineMath math="P(x)" /> oznacza funkcję pola powierzchni całkowitej takiego
          prostopadłościanu w zależności od długości <InlineMath math="x" /> krawędzi{' '}
          <InlineMath math="AB" />.
        </p>
        <p className="text-lg text-gray-800 mt-4">
          Wyznacz wzór i dziedzinę funkcji <InlineMath math="P" />. Oblicz długość{' '}
          <InlineMath math="x" /> krawędzi <InlineMath math="AB" /> tego z rozważanych
          prostopadłościanów, którego pole powierzchni całkowitej jest największe.
        </p>
