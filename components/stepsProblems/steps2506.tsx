...
const InequalityTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Zbiorem rozwiązań nierówności  $\\frac{2 - x}{3} - \\frac{2x - 1}{2} < x$ jest przedział",
    "choiceA": "$\\left(-\\infty, \\frac{1}{2}\\right)$",
    "choiceB": "$\\left(-\\infty, \\frac{1}{14}\\right)$",
    "choiceC": "$\\left(\\frac{1}{14}, +\\infty\\right)$",
    "choiceD": "$\\left(\\frac{1}{2}, +\\infty\\right)$",
    "correct_answer": "d",
  };
