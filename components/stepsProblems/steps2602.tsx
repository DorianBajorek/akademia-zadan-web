      ...
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            <StepDescription stepNumber={1}>
              Podstaw <InlineMath math="x = \frac{1}{2}" /> i <InlineMath math="y = \frac{1}{3}" /> do pierwszego równania:
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(1) && (
          <>
            <StepDescription stepNumber={2}>
              Podstaw <InlineMath math="x = \frac{1}{2}" /> i <InlineMath math="y = \frac{1}{3}" /> do drugiego równania:
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.length === 3 && (
          <StudentNotes
            ...
            solutions={["\\text{To równanie nie jest spełnione przez parę } (\\frac{1}{2}, \\frac{1}{3})"]}
          />
        )}
      </div>
    </div>
