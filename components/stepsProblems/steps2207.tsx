...
const ClassFundraiserTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Dwie klasy zebrały pieniądze na wycieczkę. Uczniowie z klasy 7a wpłacali po tyle samo, co uczniowie z klasy 7b. W klasie 7a jest 5 uczniów więcej niż w klasie 7b. Klasa 7a zebrała 480 zł, a klasa 7b — 360 zł. Wybierz poprawny układ równań.",
