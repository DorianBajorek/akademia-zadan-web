          ...
          <>
            ...
            <ChoiceQuestion
              ...
              explanation="Poprawnie wykonane mnożenie daje:
                $$\frac{2}{\sqrt{2}} \cdot \frac{\sqrt{2}}{\sqrt{2}} = \frac{2 \cdot \sqrt{2}}{\sqrt{2} \cdot \sqrt{2}}$$.
          ...
          <>
            ...
            <ChoiceQuestion
              ...
              explanation="Ostateczny wynik po usunięciu niewymierności to:
                ...
                Wyrażenie to jest już pozbawione pierwiastka w mianowniku i można je dodatkowo uprościć."
