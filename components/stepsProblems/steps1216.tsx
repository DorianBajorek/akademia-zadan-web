...
const HardcodedTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Wartość wyrażenia $5\\sqrt[3]{250} + 2\\sqrt[3]{16} - 8\\sqrt{8}$ jest równa:",
    "choiceA": "$125\\sqrt{10} + 8\\sqrt{4} - 16\\sqrt{2}$",
    "choiceB": "$18$",
    "choiceC": "$29\\sqrt[3]{2} - 16\\sqrt{2}$",
    "choiceD": "$125\\sqrt[3]{10} + 8\\sqrt[3]{2}$",
    "correct_answer": "c"
  };
