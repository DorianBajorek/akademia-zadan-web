...
const QuadraticSymmetryFromZerosTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: "mp",
    task_type: "mc4",
    description: "Funkcja $f$ jest funkcją kwadratową, dla której $f(3) = 0 = f(7)$. Osią symetrii paraboli będącej wykresem tej funkcji jest prosta:",
    choiceA: "$x = 3$",
    choiceB: "$x = 7$",
    choiceC: "$x = 5$",
    choiceD: "$x = -5$",
...
export default QuadraticSymmetryFromZerosTask;
