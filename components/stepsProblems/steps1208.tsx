        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            <StepDescription stepNumber={1}>
              Kluczem do uproszczenia jest sprowadzenie wszystkich pierwiastków do tej samej postaci. Zacznij od uproszczenia pierwszego wyrazu, wyłączając czynnik przed znak pierwiastka w <InlineMath math="\sqrt{75}"/>.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(1) && (
          <>
            <StepDescription stepNumber={2}>
              Teraz uprość drugi pierwiastek, wyłączając czynnik przed znak pierwiastka w <InlineMath math="\sqrt{192}"/>.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(2) && (
          <>
            <StepDescription stepNumber={3}>
              Uprość ostatni pierwiastek, wyłączając czynnik przed znak pierwiastka w <InlineMath math="\sqrt{108}"/>.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(3) && (
          <>
            <StepDescription stepNumber={4}>
              Podstaw uproszczone pierwiastki do pierwotnego wyrażenia i wykonaj ostateczne obliczenia.
            </StepDescription>
            <ChoiceQuestion
