    ...
    <div className="min-h-screen p-5">
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        {completedStages.includes(1) && (
          <>
            ...
            <ChoiceQuestion
              ...
              choices={[
                { label: "\\Delta = 12", value: "a" },
                { label: "\\Delta = 16", value: "b" },
                { label: "\\Delta = 4", value: "c" },
                { label: "\\Delta = 8", value: "d" }
              ]}
              correctAnswer="b"
              explanation="Delta (\\Delta) jest obliczana ze wzoru:
                ...
                Poprawna wartość delty to $$\Delta = 16$$."
        ...
        {completedStages.includes(2) && (
          <>
            ...
            <ChoiceQuestion
              ...
              choices={[
                { label: "x_{1} = 0, x_2 = 2", value: "a" },
                { label: "x_{1} = 1, x_2 = -3", value: "b" },
                { label: "x_{1} = -3, x_2 = 1", value: "c" },
                { label: "x_{1} = -1, x_2 = 3", value: "d" }
              ]}
              correctAnswer="d"
        ...
        {completedStages.length === 3 && (
          <StudentNotes
            equation="x^2 + 1 = 2(x + 2)"
            steps={[
              {
                step: "\\text{Przekształcenie równania:} x^2 + 1 = 2(x + 2) \\implies x^2 - 2x - 3 = 0",
              },
              {
                step: "\\Delta = b^2 - 4ac = (-2)^2 - 4 \\cdot 1 \\cdot (-3) = 4 + 12 = 16",
              },
              {
                step: "x_1 = \\frac{-b - \\sqrt{\\Delta}}{2a} = \\frac{2 - 4}{2} = -1",
              },
              {
                step: "x_2 = \\frac{-b + \\sqrt{\\Delta}}{2a} = \\frac{2 + 4}{2} = 3"
              },
            ]}
            solutions={["x_1 = -1, x_2 = 3"]}
          />
        )}
      </div>
    </div>
