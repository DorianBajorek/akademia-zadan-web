...
const StorePurchasesTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Właściciel sklepu kupił w hurtowni $50$ par identycznych spodni po $x$ zł za parę i $40$ identycznych marynarek po $y$ zł za sztukę. Za zakupy zapłacił $8000$ zł. Po doliczeniu marży $50%$ na spodnie i $20%$ na marynarki ceny detaliczne były jednakowe. Układ równań pozwalający obliczyć ceny hurtowe to:",
