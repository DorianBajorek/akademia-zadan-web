...
const QuadraticSymmetryAxisWithLinearTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: 'mp',
    task_type: 'mc4',
    description: 'Wskaż oś symetrii funkcji $f(x) = -2(x-2)^2 + 4x$.',
    choiceA: '$x = 2$',
    choiceB: '$x = 0$',
    choiceC: '$x = 3$',
    choiceD: '$x = -2$',
...
export default QuadraticSymmetryAxisWithLinearTask;
