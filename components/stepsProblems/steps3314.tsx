...
const SequenceDifferenceTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description: `
      Ciąg $(a_n)$ jest określony wzorem $a_n = 2n^2$ dla $n \\geq 1$.
      Różnica $a_5 - a_4$ jest równa
    `,
    choiceA: '4',
    choiceB: '20',
    choiceC: '36',
...
export default SequenceDifferenceTask;
