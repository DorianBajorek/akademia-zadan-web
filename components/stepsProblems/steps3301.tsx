      ...
      <div className="max-w-3xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            <StepDescription stepNumber={1}>
              Aby obliczyć trzeci wyraz, musimy najpierw znaleźć drugi. Użyj wzoru rekurencyjnego
              dla <InlineMath math="n=1" />, aby obliczyć <InlineMath math="a_2" />.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(1) && (
          <>
            <StepDescription stepNumber={2}>
              Mając wartość <InlineMath math="a_2" />, użyj ponownie wzoru rekurencyjnego, tym razem
              dla <InlineMath math="n=2" />, aby obliczyć <InlineMath math="a_3" />.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(2) && (
          <StudentNotes
            ...
            solutions={['\\text{Trzeci wyraz ciągu jest równy 11.}']}
          />
        )}
      </div>
    </div>
