...
const HardcodedTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: 'mp',
    task_type: 'mc4',
    description: 'Równanie $\\left|x - \\frac{1}{2}\\right| = -2$:',
    choiceA: 'Nie ma rozwiązań',
    choiceB: 'Ma jedno rozwiązanie',
    choiceC: 'Ma dwa rozwiązania',
    choiceD: 'Ma nieskończenie wiele rozwiązań',
    correct_answer: 'a',
  };
