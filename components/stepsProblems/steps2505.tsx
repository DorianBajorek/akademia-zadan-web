...
const InequalityTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Zbiorem wszystkich rozwiązań nierówności $\\frac{1 - 2x}{2} > \\frac{1}{3}$ jest przedział",
    "choiceA": "$\\left(-\\infty, \\frac{1}{6}\\right)$",
    "choiceB": "$\\left(-\\infty, \\frac{2}{3}\\right)$",
    "choiceC": "$\\left(\\frac{1}{6}, +\\infty\\right)$",
    "choiceD": "$\\left(\\frac{2}{3}, +\\infty\\right)$",
    "correct_answer": "a"
  };
