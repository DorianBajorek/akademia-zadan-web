...
const QuadraticIncreasingIntervalTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: "mp",
    task_type: "mc4",
    description: "Wskaż w jakim przedziale funkcja $f(x) = -2(x-1)^2 - 1$ jest rosnąca.",
    choiceA: "$(-\\infty, 1)$",
    choiceB: "$(1, +\\infty)$",
    choiceC: "$(-\\infty, -1)$",
    choiceD: "$(-1, +\\infty)$",
...
export default QuadraticIncreasingIntervalTask;
