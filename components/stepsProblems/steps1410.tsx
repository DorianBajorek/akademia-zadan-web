...
const EquationSolutionsTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Ile rozwiązań ma równanie: $x^2 - 1 = \\frac{1}{2}(x^2 + x)$?",
    "choiceA": "0",
    "choiceB": "1",
    "choiceC": "2",
    "choiceD": "Nieskończenie wiele",
    "correct_answer": "c"
  };
...
export default EquationSolutionsTask;