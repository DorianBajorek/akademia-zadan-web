          ...
          <>
            ...
            <ChoiceQuestion
              ...
              choices={[
                ...
                { label: "\\text{Największa liczba pierwsza dzieląca liczbę z resztą}", value: "c" },
        ...
        {completedStages.includes(1) && (
          <>
            ...
            <ChoiceQuestion
              ...
              choices={[
                { label: "\\text{Rozłożyć 42 na czynniki pierwsze: $$2 \cdot 3 \cdot 7$$ i wybrać największy}", value: "a" },
