...
const TransportPricingTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description:
      'Firma przewozowa stosuje następującą zasadę: Funkcja $f$ przyporządkowuje liczbę przejechanych kilometrów do ceny przejazdu według reguły: - do $5$ km – opłata stała: $10$ zł, - za każdy rozpoczęty kilometr powyżej $5$ km – dodatkowe $2$ zł za kilometr. Ile wynosi $f(8)$, czyli cena przejazdu za $8$ km?',
