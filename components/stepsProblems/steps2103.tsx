...
const FirstDigitFunctionTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: "mp",
    task_type: "mc4",
    description: "Dana jest funkcja $f$, która każdej liczbie naturalnej przyporządkowuje jej pierwszą cyfrę. Ile wynosi $f(1234)$?",
    choiceA: "1",
    choiceB: "2",
    choiceC: "3",
    choiceD: "4",
...
export default FirstDigitFunctionTask;