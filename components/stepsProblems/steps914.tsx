...
const HardcodedTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description:
      'Na początku sezonu letniego cenę $x$ pary sandalów podwyższono o $20\\%$. Po miesiącu nową cenę obniżono o $10\\%$. Po obu tych zmianach ta para sandalów kosztowała $81$ zł. Początkowa cena $x$ pary sandalów była równa',
    choiceA: '45 zł',
    choiceB: '73,63 zł',
    choiceC: '75 zł',
    choiceD: '87,48 zł',
