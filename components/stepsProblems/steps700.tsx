...
w których zapisie dziesiętnym występują tylko cyfry $$2, 4, 7$$ (np.: $$7272, 2222, 7244$$)?"
        ...
        {completedStages.length === 0 && (
          <StepDescription stepNumber={1}>
            Zauważmy, że w tym zadaniu możemy używać danych cyfr wielokrotnie. Rozważmy ile
            możliwych różnych cyfr może znaleźć się na każdej pozycji.
          </StepDescription>
        )}
...
gdyż nie ma to wpływu na parzystość wynikowej liczby."
        ...
        {completedStages.includes(2) && (
          <>
            <StepDescription stepNumber={3}>Przeanalizujmy trzecią pozycję.</StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(5) && (
          <>
            <StepDescription stepNumber={6}>Oblicz wynik końcowy.</StepDescription>
            <NumericQuestion
        ...
        {completedStages.length === 6 && (
          <StudentNotes
            ...
            steps={[{ step: 'x = 3 \\cdot 3 \\cdot 3 \\cdot 2' }, { step: 'x = 54' }]}
