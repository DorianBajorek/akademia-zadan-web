...
const QuadraticBTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: "mp",
    task_type: "mc4",
    description: "Wyznacz współczynnik $b$ funkcji kwadratowej $f(x) = x^2 + bx - 4$, jeśli wiadomo, że prosta $x = 3$ jest jej osią symetrii.",
    choiceA: "$b = 6$",
    choiceB: "$b = -6$",
    choiceC: "$b = -3$",
    choiceD: "$b = 3$",
