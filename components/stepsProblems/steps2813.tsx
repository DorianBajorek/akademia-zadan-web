...
const QuadraticAxisRoot2Task: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: "mp",
    task_type: "mc4",
    description: "Wskaż oś symetrii funkcji kwadratowej $f(x)=\\sqrt{2}x^2 + (1-\\sqrt{2})x + 3$.",
    choiceA: "$x=\\frac{1+\\sqrt{2}}{2\\sqrt{2}}$",
...
export default QuadraticAxisRoot2Task;
