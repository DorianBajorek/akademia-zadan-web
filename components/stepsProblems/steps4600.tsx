...
const ParallelLinesTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description: `
        Prosta równoległa do prostej o równaniu $y = \\frac{2}{3}x - \\frac{4}{3}$ jest prosta opisana równaniem
    `,
    choiceA: '$y = -\\frac{2}{3}x + \\frac{4}{3}$',
    choiceB: '$y = \\frac{2}{3}x + \\frac{4}{3}$',
    choiceC: '$y = \\frac{3}{2}x - \\frac{4}{3}$',
    choiceD: '$y = -\\frac{3}{2}x - \\frac{4}{3}$',
    correct_answer: 'b',
  };
