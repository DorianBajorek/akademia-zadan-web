        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            ...
            <ChoiceQuestion
              ...
              choices={[
                { label: "5^x = \\sqrt{125}", value: "a" },
                { label: "x^5 = \\sqrt{125}", value: "b" },
                { label: "5 \\cdot x = \\sqrt{125}", value: "c" },
        ...
        {completedStages.includes(3) && (
          <>
            ...
            <ChoiceQuestion
              ...
              correctAnswer="a"
              explanation="Poprawne rozwiązanie to $$x = \frac{3}{2}$$. <br>
              Dlaczego? Wynika to bezpośrednio z porównania wykładników $$5^x = 5^{\frac{3}{2}}$$."
