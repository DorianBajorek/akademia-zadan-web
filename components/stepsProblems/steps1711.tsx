...
const QuadraticIncreasingTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Funkcja kwadratowa jest określona wzorem $f(x) = (x-1)(x-9)$. Wynika stąd, że funkcja $f$ jest rosnąca w przedziale:",
    "choiceA": "$\\langle5; \\infty)$",
...
export default QuadraticIncreasingTask;