...
const HardcodedTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: 'mp',
    task_type: 'mc4',
    description: 'Równanie $|\\frac{2x - 1}{3}| = \\frac{5}{2}$ ma rozwiązania:',
    choiceA: '$x = \\frac{17}{4}$ lub $x = -\\frac{13}{4}$',
    choiceB: '$x = \\frac{13}{4}$ lub $x = -\\frac{17}{4}$',
    choiceC: '$x = \\frac{17}{2}$ lub $x = -\\frac{13}{2}$',
    choiceD: '$x = \\frac{13}{2}$ lub $x = -\\frac{17}{2}$',
    correct_answer: 'a',
  };
