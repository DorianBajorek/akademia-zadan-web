...
const ParallelLinesTask2: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: "mc4",
    description: `
        Proste o równaniach: $y = (2m + 3)x + 4$ oraz $y = (5 - m)x - 2$ są równoległe, gdy:
    `,
    choiceA: "$m = \\frac{2}{3}$",
    choiceB: "$m = -\\frac{8}{3}$",
    choiceC: "$m = 1$",
    choiceD: "$m = -2$",
    correct_answer: "a" // Poprawna odpowiedź to A (m = 2/3)
  };
...
export default ParallelLinesTask2;