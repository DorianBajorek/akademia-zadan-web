      ...
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
            ...
            <StepDescription stepNumber={1}>
                Zacznij od uproszczenia pierwszego wyrazu. Aby uprościć <InlineMath math="\sqrt[3]{24}"/>, znajdź największy sześcian liczby całkowitej, który jest dzielnikiem 24.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(1) && (
            ...
            <StepDescription stepNumber={2}>
                Uprość drugi wyraz. Aby uprościć <InlineMath math="\sqrt{48}"/>, znajdź największy kwadrat liczby całkowitej, który jest dzielnikiem 48.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(4) && (
            ...
            <StepDescription stepNumber={5}>
                Podstaw wszystkie uproszczone pierwiastki do pierwotnego wyrażenia. Zgrupuj osobno wyrazy z <InlineMath math="\sqrt{3}"/> i <InlineMath math="\sqrt[3]{3}"/>, a następnie wykonaj ostateczne obliczenia.
            </StepDescription>
            <ChoiceQuestion
