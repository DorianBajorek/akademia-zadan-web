    ...
    <div className="min-h-screen p-5">
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        <p className="text-2xl font-bold text-gray-900 text-center mt-4">
          <InlineMath math="\frac{3}{\sqrt{2}+1}" />
        </p>
        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            ...
            <ChoiceQuestion
              ...
              correctAnswer="a"
              explanation="Gdy w mianowniku mamy wyrażenie postaci $$(\sqrt{a} + \sqrt{b})$$, należy pomnożyć licznik i mianownik przez sprzężenie mianownika (czyli to samo wyrażenie, ze zmienionym znakiem pomiędzy), czyli $$(\sqrt{a} - \sqrt{b})$$. 
              W tym przypadku sprzężeniem jest $$(\sqrt{2} - 1)$$. Dzięki temu w mianowniku skorzystamy ze wzoru skróconego mnożenia $$(a+b)(a-b) = a²-b²$$."
        ...
        {completedStages.includes(1) && (
          <>
            <p className="text-lg text-gray-700 mt-6">
              Wykonaj mnożenie licznika i mianownika przez (√2 - 1).
            </p>
            <ChoiceQuestion
              question="Które wyrażenie jest wynikiem poprawnego mnożenia?"
              choices={[
                { label: "\\frac{3(\\sqrt{2}-1)}{(\\sqrt{2}+1)(\\sqrt{2}-1)}", value: "a" },
                { label: "\\frac{3}{(\\sqrt{2}+1)(\\sqrt{2}-1)}", value: "b" },
                { label: "\\frac{3\\sqrt{2}-3}{2-1}", value: "c" },
        ...
        {completedStages.includes(2) && (
          <>
            ...
            <NumericQuestion
              question="Jaka jest wartość mianownika (√2 + 1)(√2 - 1)?"
              correctAnswer="1"
          ...
          <>
            ...
            <ChoiceQuestion
              ...
              explanation="Ostateczny wynik po usunięciu niewymierności to:
                ...
                $$\frac{3}{\sqrt{2}+1} = \frac{3(\sqrt{2}-1)}{(\sqrt{2}+1)(\sqrt{2}-1)} = \frac{3\sqrt{2}-3}{1} = 3\sqrt{2}-3$$.
        ...
        {completedStages.length === 4 && (
          <StudentNotes
            ...
            steps={[
              {
                step: "\\frac{3}{\\sqrt{2}+1} = \\frac{3(\\sqrt{2}-1)}{(\\sqrt{2}+1)(\\sqrt{2}-1)} = \\frac{3\\sqrt{2}-3}{2-1} = 3\\sqrt{2}-3",
              }
            ]}
