...
const GeometricSequenceQuotientTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: "mc4",
    description: `
            W ciągu geometrycznym $a_{n}$ którego wszystkie wyrazy są dodatnie iloraz jest równy $$q$$.
            Wskaż prawdziwą równość
    `,
    choiceA: "$q = \\frac{a_1}{q}$",
    choiceB: "$q^2= \\frac{a_5}{a_4}$",
    choiceC: "$q= \\frac{a_3}{a_2}$",
    choiceD: "$q^3 = \\frac{a_3}{a_1}$",
    correct_answer: "c"
  };
