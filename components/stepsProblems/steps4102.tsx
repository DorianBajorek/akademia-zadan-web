      ...
      <div className="max-w-3xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            <StepDescription stepNumber={1}>
              Zastosuj zasadę iloczynu równego zero: iloczyn jest równy zero wtedy i tylko wtedy,
              gdy co najmniej jeden z jego czynników jest równy zero.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(1) && (
          <>
            <StepDescription stepNumber={2}>
              Rozwiąż pierwsze równanie <InlineMath math="x^2 - 27 = 0" /> i znajdź jego pierwiastki
              rzeczywiste.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(2) && (
          <>
            <StepDescription stepNumber={3}>
              Teraz przeanalizuj drugie równanie <InlineMath math="x^2 + 16 = 0" />. Czy ma ono
        ...
        {completedStages.includes(3) && (
          <>
            <StepDescription stepNumber={4}>
              Zbierz wszystkie unikalne rozwiązania rzeczywiste z obu przypadków i policz, ile ich
              jest.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(4) && (
          <StudentNotes
            ...
            solutions={['\\text{Łącznie istnieją dwa rozwiązania rzeczywiste.}']}
          />
        )}
      </div>
    </div>
