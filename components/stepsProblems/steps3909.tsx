...
const GeometricSequenceRatioTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: "mc4",
    description: `
      W kartezjańskim układzie współrzędnych $(x, y)$ narysowano wykres funkcji $y = f(x)$ (zobacz rysune). Wyznacz zbiór wartości podanej funkcji.
    `,
    choiceA: "$(-5;5)$",
    choiceB: "$\\langle-5;5\\rangle$",
    choiceC: "$(-3;1\\rangle \\cup \\langle1;3)$",
    choiceD: "$\\langle-3;1\\rangle \\cup \\langle1;3\\rangle$",
    correct_answer: "d",
    descriptionImg: "/problemImages/problem3909.png",
  };
