        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            <StepDescription stepNumber={1}>
              Korzystając ze wzoru na <InlineMath math="n" />
              -ty wyraz ciągu, utwórz równanie dla <InlineMath math="a_5 = 9" />.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(3) && (
          <>
            <StepDescription stepNumber={4}>
              Podstaw wyznaczoną wartość <InlineMath math="r" /> do jednego z równań, aby obliczyć{' '}
              <InlineMath math="a_1" />.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(4) && (
          <>
            <StepDescription stepNumber={5}>
              Podstaw <InlineMath math="a_1" /> i <InlineMath math="r" /> do wzoru ogólnego, aby go
              sformułować.
            </StepDescription>
            <ChoiceQuestion
