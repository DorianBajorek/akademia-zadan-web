...
const TrigonometryTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description: `
      Kąt $\\alpha$ jest ostry oraz $\\mathrm{tg}\\alpha = 7$. Cosinus kąta $\\alpha$ wynosi:
    `,
    choiceA: '$\\frac{\\sqrt{7}}{7}$',
    choiceB: '$\\frac{1}{50}$',
    choiceC: '$\\frac{\\sqrt{2}}{10}$',
    choiceD: '$\\frac{7}{50}$',
    correct_answer: 'c',
  };
...
export default TrigonometryTask;
