          ...
          {(completedStages.includes(1) || completedStages.length === 0) && (
            <div>
              <StepDescription stepNumber={1}>
                Oszacujmy wartość pierwiastka aby wiedzieć, czy wartość pod pierwiastkiem jest ujemna czy dodatnia.
              </StepDescription>
              <ChoiceQuestion
          ...
          {completedStages.includes(1) && (
            <div>
              <StepDescription stepNumber={2}>
                Określmy czy wewnątrz pierwiastka jest liczba ujemna. Jeśli tak to usuwając wartość bezwzględną zmienimy znak na ujemny, jeśli nie znaku nie zmienimy.
              </StepDescription>
              <ChoiceQuestion
