...
const BallHeightFunctionTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description:
      'Funkcja $f$ opisuje wysokość piłki (w metrach) w czasie lotu, gdzie: - Piłka została podrzucona pionowo w górę, - Wznosiła się przez $2$ sekundy do wysokości $8$ metrów, - Następnie opadała przez kolejne $2$ sekundy, aż wróciła na ziemię. Jaki jest zbiór wartości funkcji $f$?',
