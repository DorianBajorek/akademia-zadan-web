...
const GeometricSequenceRatioTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: "mc4",
    description: `
      W kartezjańskim układzie współrzędnych $(x, y)$ narysowano wykres funkcji $y = f(x)$ (zobacz rysune). Ile rozwiązań w przedziale $(-4;6)$ ma równanie $f(x) = -1$.
    `,
    choiceA: "$\\text{Nie ma rowiązań}$",
    choiceB: "$\\text{Ma jedno rozwiązanie}$",
    choiceC: "$\\text{Ma dwa rozwiązania}$",
    choiceD: "$\\text{Ma trzy rozwiązania}$",
    correct_answer: "c",
    descriptionImg: "/problemImages/problem3912.png",
  };
