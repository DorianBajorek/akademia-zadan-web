...
const MilkCanTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "description": "Pusta bańka na mleko o pojemności $10$ litrów ma masę $6.5$ kg. Jeden litr mleka ma masę $1.03$ kg. Niech $x$ oznacza liczbę litrów mleka w tej bańce, a $f(x)$ oznacza wyrażoną w kilogramach masę bańki wraz z mlekiem, gdzie $ x \\in (0,10) $.",
    "statements": [
      {
