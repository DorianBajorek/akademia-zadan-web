    ...
    <div className="min-h-screen p-5">
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        ...
        <p className="text-lg text-gray-800 mt-4">
          Dana jest funkcja <InlineMath math="f(x) = 2x^2 - 3x + 5" />. Oblicz wartość tej funkcji
          dla argumentu <InlineMath math="x = -2" />.
        </p>
        ...
        {(completedStages.includes(0) || completedStages.length === 0) && (
          <>
            <ChoiceQuestion
              ...
              choices={[
                {
                  label: '\\text{Podstawić argument do wzoru funkcji i obliczyć jej wartość}',
                  value: 'a',
                },
