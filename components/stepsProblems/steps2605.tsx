...
const EquationSystemTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: 'mp',
    task_type: 'mc4',
    description: 'Para liczb $(3, -2)$ spełnia układ równań:',
    choiceA: '$\\begin{cases} 2x - y = 8 \\\\ -3x + 2y = -5 \\end{cases}$',
    choiceB: '$\\begin{cases} 2x + y = 4 \\\\ -3x + 2y = -13 \\end{cases}$',
    choiceC: '$\\begin{cases} 2x + y = -1 \\\\ -3x + 2y = 12 \\end{cases}$',
    choiceD: '$\\begin{cases} 2x - y = 1 \\\\ -3x + 2y = 0 \\end{cases}$',
    correct_answer: 'b',
  };
