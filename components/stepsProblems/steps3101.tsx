        ...
        {(completedStages.includes(1) || completedStages.length === 0) && (
          <>
            <StepDescription stepNumber={1}>
              Użyj wzoru na <InlineMath math="n"/>-ty wyraz ciągu, aby zapisać równanie dla <InlineMath math="a_9"/>.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(1) && (
          <>
            <StepDescription stepNumber={2}>
              Wykorzystaj podaną wartość <InlineMath math="a_9=5"/>, aby obliczyć różnicę <InlineMath math="r"/>.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(2) && (
          <>
            <StepDescription stepNumber={3}>
              Wybierz poprawny wzór na sumę <InlineMath math="n"/> początkowych wyrazów ciągu arytmetycznego.
            </StepDescription>
            <ChoiceQuestion
        ...
        {completedStages.includes(3) && (
          <>
            <StepDescription stepNumber={4}>
              Podstaw wszystkie znane wartości do wzoru na sumę, aby obliczyć <InlineMath math="S_9"/>.
            </StepDescription>
            <ChoiceQuestion
