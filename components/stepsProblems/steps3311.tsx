...
const SequenceFifthTermTask: React.FC = () => {
  ...
  const taskData = {
    ...
    task_type: 'mc4',
    description: `
      Ciąg $(a_n)$ jest określony wzorem $a_n = \\dfrac{n-2}{2n^2}$ dla każdej liczby naturalnej $n \\geq 1$.
...
export default SequenceFifthTermTask;
