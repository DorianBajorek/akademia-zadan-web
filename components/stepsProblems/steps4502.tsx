  ...
  return (
    <div className="min-h-screen p-5">
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        <h2 className="text-3xl font-bold text-gray-800 text-center mb-6">Analiza wykresu funkcji stałej</h2>
        ...
        {completedStages.includes(2) && (
          <>
            ...
            <ChoiceQuestion
              ...
              img="/steps-images/funkcja-stala-dodatnia.png"
            />
          </>
        )}
        ...
        {completedStages.length === 3 && (
          <StudentNotes
            ...
            solutions={["\\text{Odpowiedź B: }a = 0 i b > 0"]}
          />
        )}
      </div>
    </div>
