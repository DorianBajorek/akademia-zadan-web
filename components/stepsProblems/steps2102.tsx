  ...
  return (
    <div className="min-h-screen p-5">
      <div className="max-w-5xl w-full bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-300 mx-auto mt-6 md:mt-10">
        <h2 className="text-3xl font-bold text-gray-800 text-center mb-6">Analiza zmiany ceny telefonu</h2>
        <p className="text-lg text-gray-800 mt-4">
          Cena nowego telefonu w sklepie internetowym przez pierwszy tydzień wynosiła 3000 zł. Po tygodniu zaczęła spadać codziennie o 100 zł aż do osiągnięcia poziomu 2400 zł. Potem utrzymywała się na tym poziomie przez kolejne dni.
        </p>
        ...
        {(completedStages.includes(1) && (completedStages.includes(2) || completedStages.length === 2)) && (
          <>
            <ChoiceQuestion
              ...
              choices={[
                { label: "\\text{Stała (0-7 dni), malejąca (7-13 dni), stała (powyżej 13 dni)}", value: "a" },
                { label: "\\text{Stała (0-7 dni), malejąca (7-13 dni)}", value: "b" },
                { label: "\\text{Malejąca (0-6 dni), stała (powyżej 6 dni)}", value: "c" },
                { label: "\\text{Stała (0-7 dni), malejąca (8-13 dni), stała (powyżej 13 dni)}", value: "d" }
              ]}
              correctAnswer="d"
