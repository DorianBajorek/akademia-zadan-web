...
const QuadraticFunctionVertexTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: 'mp',
    task_type: 'mc4',
    description: 'Wierzchołkiem funkcji kwadratowej $f(x)=2x^2-4x+8$ jest punkt',
    choiceA: '$(1, 6)$', // poprawna odpowiedź
    choiceB: '$(2, 8)$', // błędna - zapomniano podzielić przez 2a
    choiceC: '$(-1, 14)$', // błędna - zły znak współrzędnej x
    choiceD: '$(4, 24)$', // błędna - podstawienie x=4 do wzoru funkcji
    correct_answer: 'a',
  };
...
export default QuadraticFunctionVertexTask;
