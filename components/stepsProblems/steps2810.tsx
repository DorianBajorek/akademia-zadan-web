...
const QuadraticAxisTask: React.FC = () => {
  ...
  const taskData = {
    ...
    exam_type: "mp",
    task_type: "mc4",
    description: "Wierzchołkiem paraboli jest punkt $W = (2,\\,-4)$. Liczby $0$ i $4$ to jej miejsca zerowe. Wskaż równanie osi symetrii paraboli.",
    choiceA: "$y = -4$",
    choiceB: "$x = -4$",
    choiceC: "$y = 2$",
    choiceD: "$x = 2$",
...
export default QuadraticAxisTask;
