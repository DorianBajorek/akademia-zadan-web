...
const QuadraticSumTask: React.FC = () => {
  ...
  const taskData = {
    ...
    "exam_type": "mp",
    "task_type": "mc4",
    "description": "Równanie $x^2 - 8x + 1$ ma dwa rozwiązania $x_1$ i $x_2$, takie że $x_1 > x_2$. Ile wynosi $2x_1 + x_2$?",
    "choiceA": "$8 + \\sqrt{15}$",
    "choiceB": "$12 + 2\\sqrt{15}$",
    "choiceC": "$12$",
    "choiceD": "$12 + \\sqrt{15}$",
    "correct_answer": "d"
  };
...
export default QuadraticSumTask;